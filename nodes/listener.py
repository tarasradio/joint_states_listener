...
import threading
from joint_states_listener.srv import ReturnJointStates, ReturnJointStatesResponse
...
class LatestJointStates:
	...
	def joint_states_listener(self):
		rospy.Subscriber(self.ns + 'joint_states', JointState, self.joint_states_callback)
		rospy.spin()
...
if __name__ == "__main__":
	...
	latestjointstates = LatestJointStates(ns = '/ar600/')
